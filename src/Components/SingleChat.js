...
const ENDPOINT = 'https://mern-backend-messenger.herokuapp.com/';
  ...
  const fetchMessages = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://mern-backend-messenger.herokuapp.com/api/message/${selectedChat._id}`,
        config
      );
      setMessages(data);
      setLoading(false);
    ...
    if (event.key === "Enter" && newMessage) {
      ...
      try {
        ...
        const { data } = await axios.post(
          "https://mern-backend-messenger.herokuapp.com/api/message",
          {
            content: newMessage,
            chatId: selectedChat,
          },
